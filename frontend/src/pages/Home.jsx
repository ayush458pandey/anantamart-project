...
export default function Home() {
    ...
    return (
        <div className="flex flex-col sm:block h-full -mx-3 sm:mx-0">
            ...
            {/* Mobile Search - rendered inside header via portal */}
            {document.getElementById('header-extension') && createPortal(
                <div className="px-3 sm:px-4 pb-2 pt-1 bg-white sm:hidden border-b border-gray-100 shadow-sm">
                    {/* Search Bar */}
            ...
            {/* Main Content Area: Split screen on mobile */}
            <div className="flex flex-1 overflow-hidden sm:overflow-visible">
                {/* Mobile Left Sidebar */}
                <div className="w-[80px] flex-shrink-0 bg-[#f3f4f6] overflow-y-auto hide-scrollbar sm:hidden h-[calc(100vh-130px)]">
                    <CategoryDirectory 
                ...
                {/* Right Content Area / Desktop Full Width */}
                <div className="flex-1 overflow-y-auto h-[calc(100vh-130px)] sm:h-auto sm:overflow-visible bg-white relative">
                    ...
                    <div className="px-3 sm:px-0 pt-3 sm:pt-0 pb-10">
            ...
            {/* Page Title - Now only visible on Desktop */}
            <div className="hidden sm:flex mb-3 sm:mb-4 px-1 items-start justify-between gap-3">
                ...
                <>
                    ...
                    {selectedCategory === 'all' && !searchQuery ? (
                        <div className="space-y-8 pb-10">
                            ...
                            <div className="space-y-10 border-t border-gray-100 pt-8 sm:pt-4 sm:border-t-0">
